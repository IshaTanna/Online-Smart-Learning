...
?>  
    ...
    <input type="password" name="OldPassword" class="form-control" id="exampleInputPassword1" placeholder="Old Password" required >
	</div>
	<div class="form-group">
    <label for="exampleInputPassword1">Enter New Password</label>
    <input type="password" name="NewPassword" class="form-control" id="exampleInputPassword1" placeholder="New Password" required >
	</div>
	<div class="form-group">
    <label for="exampleInputPassword1">Enter New Confirm Password</label>
    <input type="password" name="NewConfirmPassword" class="form-control" id="exampleInputPassword1" placeholder="New Confirm Password" required >
	</div>
